  ...
  return (
    <div className='main-page'>
      <div className='profile-wrapper'>
        ...
        <h6>
          Rising Junior with Computer Science Major and Mathematics minor at Texas Christian University
          <span>
        ...
        <button type="button" class="btn btn-primary view-more-btn" onClick={handleClick}>
          View more about me
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-index-thumb unique-icon" viewBox="0 0 16 16">
